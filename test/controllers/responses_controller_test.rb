...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference("Response.count") do
      post responses_url, params: { response: { survey_id: @response.survey_id, uploader_id: @response.uploader_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { survey_id: @response.survey_id, uploader_id: @response.uploader_id } }
